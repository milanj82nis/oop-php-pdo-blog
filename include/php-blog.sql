...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2021 at 12:24 PM
...
CREATE TABLE `users` (
  ...
  `featured_image` varchar(211) DEFAULT 'https://usapng.com/images/bt/user-icon-6.png',
  `is_admin` int(12) NOT NULL DEFAULT 0,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
